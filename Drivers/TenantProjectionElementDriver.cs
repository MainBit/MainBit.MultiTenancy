...
using Orchard;
using MainBit.MultiTenancy.Elements;
...
{
    [OrchardFeature("MainBit.MultiTenancy.Layouts")]
    public class TenantProjectionElementDriver : FormsElementDriver<TenantProjection>
    {
        ...
        protected override IEnumerable<string> FormNames {
            get {
                yield return "TenancyProjectionForm";
            }
        }
